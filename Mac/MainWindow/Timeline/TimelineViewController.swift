...
final class TimelineViewController: NSViewController, UndoableCommandRunner, UnreadCountProvider {
	...
	private func calculateRowHeight() -> CGFloat {
		...
		let prototypeArticle = Article(accountID: prototypeID, articleID: prototypeID, feedID: prototypeID, uniqueID: prototypeID, title: longTitle, contentHTML: nil, contentText: nil, markdown: nil, url: nil, externalURL: nil, summary: nil, imageURL: nil, datePublished: nil, dateModified: nil, authors: nil, tags: nil, status: status)
